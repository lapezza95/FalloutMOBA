...
public class MOBA_FreeCamera_rev1 : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        m_Target = GameObject.Find("FollowCamera");

        //Vector3 TargetPosition = m_Target.position;
        //TargetPosition.y = 18f;
        //transform.position = m_Target.position;
        transform.position = Vector3.SmoothDamp(transform.position, m_Target.transform.position, ref refVelocity, m_SmoothSpeed);
